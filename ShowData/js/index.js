        ...
        success: function(response) {
            if (response.data.length) {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        let data = JSON.parse(response.data);
                        $(".today-notice>span").text(data[0].showNotice);
                    }
                });
                ...
                var chinaoption = {
                    tooltip: {
                        ...
                        formatter: function(params, ticket, callback) {
                            ...
                            htmlStr+='<div style="text-align:center;font-size:22px;border-top:1px soild rgba(255,255,255,.8);' +
                                'border-top: 1px solid #d5d5d5;width:100%;"><a style="text-decoration:none;color:#fff" href='+href+'>详情</a></div>';
                            return htmlStr;
                        },
                        textStyle: {
                            fontSize: 22,
